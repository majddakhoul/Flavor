...
@section('body')
    <main id="main" class="shell center" style="min-height:100vh;display:grid;place-content:center;gap:var(--space-3)">
        ...
        <p class="eyebrow">{{ __('errors.code', ['code' => '500']) }}</p>
        <h1>{{ __('errors.title_500') }}</h1>
        <p class="lede" style="margin-inline:auto">{{ ($exception ?? null)?->getMessage() ?: __('errors.body_500') }}</p>
